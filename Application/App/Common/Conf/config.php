...
/* 系统数据加密设置 */
'DATA_AUTH_KEY' => 'm:24iyNJ~1$z(^SjGxe&ngorTfA#7EFu<?.c]Yt+', //默认数据加密KEY
...
/* Redis 配置 */
'REDIS_HOST'            => '0144e112abe149ed.m.cnqda.kvstore.aliyuncs.com', //主机
'REDIS_PORT'            => '6379', //端口
'REDIS_AUTH'            => '0144e112abe149ed:027Xunniutech',
'REDIS_DB_NUM'		=> 7,
'DATA_CACHE_TIME'       => 120,      // 数据缓存有效期 0表示永久缓存
'DATA_CACHE_TYPE'       => 'Redis',  // 数据缓存类型
'DATA_CACHE_DB_INDEX'   => 6,        // 测试环境使用6号数据库 
...
'exts'     => 'jpg,gif,png,jpeg,zip,rar,tar,gz,7z,doc,docx,txt,xml,amr', //允许上传的文件后缀
