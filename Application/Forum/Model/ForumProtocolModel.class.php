...
class ForumProtocolModel extends Model
{
    ...
    // 在个人空间里查看该应用的内容列表
    public function profileList($uid = null, $page = 1, $count = 15, $tab = null)
    {
        $tab = $tab ? $tab : 'forum';
