/**
 * Created by hisihi on 2016/10/27.
 */
requirejs.config({
    ...
    paths: {
        ...
        home:'events/workscontent/workscontent-3.2',
...
require(['home'],function(Work) {
    ...
    window.Competition = new Work($('.wrapper'), id, window.hisihiUrlObj.api_url_php);
});